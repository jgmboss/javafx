...
public class OneItemSelectedManager {

    public static Scene oneItemSelectedManager() {
        ...
        Button toEdit = new Button();
        toEdit.setPrefSize(162, 31);
        toEdit.setOnAction((ae) -> OneItemSelectController.toEdit());
